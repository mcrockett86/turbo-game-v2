...
export const ZONES: Record<string, Zone> = {
  suburban_streets: {
    ...
    flavor: 'Familiar streets, familiar squirrels — and a long way home.',
    ...
    features: [
      ...
      { type: 'hint', x: -8, z: -4, id: 'street_map', label: '🐾 Scent Mark', item: 'map_fragment', readable: true },
  ...
  dog_park: {
    ...
    transition: 'slide',
    name: '🌳 Dog Park',
    flavor: 'A fence, a grassy bowl, and every other dog’s nose on the wind.',
    ...
    features: [
      { type: 'water_bowl', x: 6, z: 3, id: 'water_bowl', label: '💧 Water Bowl', examine: 'A full water bowl, ringed with paw prints. Everyone is welcome here.' },
      { type: 'mailbox', x: -6, z: 6, id: 'park_hydrant', label: '🚒 Storm Drain', threat: 'storm_sewer' },
      { type: 'fire_hydrant', x: -5, z: -2, id: 'fire_hydrant', label: '🚒 Fire Hydrant', examine: 'Rusty from a thousand sniffs. Every dog on this block checks in here first.' },
      { type: 'scent_post', x: 0, z: 7, id: 'scent_post', label: '🐾 Scent Post', examine: 'A scent post — a tree marked by dogs looking for the way home. My mark is right here.' },
  ...
  apartment: {
    ...
    flavor: 'A strange house — but a red ball by the bed. Someone threw that ball for me.',
    ...
    rooms: [
      ...
      { id: 'apt_living', name: 'Living Room', w: 200, h: 100, d: 180, color: '#7a6a5a', exits: ['apt_entrance', 'apt_bedroom'], features: [{type:'tv', x:100, y:50, w:60, h:40, label:'📺 TV (barks back)', examine:'The show is paused mid-walk, on a channel that barks back. The couch cushion is still warm.'}, { type: 'treasure', x: 50, y: 50, w: 40, h: 30, label: '✨ blanket', item: 'blanket' }, { type: 'treasure', x: 50, y: 50, w: 40, h: 30, label: '✨ home_photo', item: 'home_photo' }, { type: 'treasure', x: 50, y: 50, w: 40, h: 30, label: '✨ diary_page', item: 'diary_page' }, { type: 'treasure', x: 50, y: 50, w: 40, h: 30, label: '✨ squirrel_dog', item: 'squirrel_dog' },] },
      ...
      { id: 'apt_bathroom', name: 'Bathroom', w: 100, h: 80, d: 100, color: '#8a8a9a', exits: ['apt_kitchen', 'apt_bedroom'], features: [{type:'water_bowl', x:50, y:40, w:30, h:30, label:'💧 Water Bowl', examine:'A fresh water bowl in a human bathroom. This family is always home — and always gone at the same time.'}] },
      { id: 'apt_balcony', name: 'Balcony', w: 120, h: 70, d: 80, color: '#5a7a5a', exits: ['apt_living'], features: [{type:'hint', x:60, y:35, w:40, h:30, label:'🌳 View', item:'tree_clue', readable:true}] }
    ],
    music: 'apartment',
  ...
  shelter: {
    ...
    transition: 'fade',
    name: '🏥 Animal Shelter',
    flavor: 'Kennels full of hope. Maybe one of them remembers the way home.',
    ...
    rooms: [
      ...
      { id: 'shelter_office', name: 'Office', w: 120, h: 80, d: 100, color: '#6a6a7a', exits: ['shelter_lobby'], features: [{type:'hint', x:60, y:40, w:40, h:30, label:'📋 Poster', item:'map_fragment', readable:true}] },
      ...
      { id: 'shelter_vet', name: 'Vet Room', w: 100, h: 80, d: 100, color: '#9a9aaa', exits: ['shelter_lobby'], features: [{type:'hint', x:50, y:40, w:40, h:30, label:'📋 Medical Record', item:'collar', readable:true}] }
    ],
  ...
  neighborhood: {
    ...
    flavor: 'The air tastes different here. I am getting closer. I can feel it.',
    ...
    rooms: [
      ...
      { id: 'neighborhood_library', name: 'Library', w: 140, h: 90, d: 120, color: '#7a6a5a', exits: ['neighborhood_start'], features: [{type:'hint', x:70, y:45, w:50, h:30, label:'📚 Lost Dog Poster', item:'photo', readable:true}] },
  ...
  home: {
    ...
    transition: 'zoom',
    name: '🏡 Home',
    flavor: 'The golden gate. The yard. My heart stops — this is where I belong.',
  ...
  lake: {
    ...
    transition: 'fade',
    name: '🌊 The Lake',
    flavor: 'The water remembers my paws. The last swim ended here, with a human laughing.',
  ...
  pet_store: {
    ...
    transition: 'wipe',
    name: '🏪 Pet Paradise',
    flavor: 'Treat smells, a hanging bell, and a voice that always opened the door for me.',
  ...
  dog_show: {
    ...
    transition: 'zoom',
    name: '🏆 Dog Show Arena',
    flavor: 'The crowd roar. I still hear the day I won the blue ribbon.',
  ...
  forest: {
    ...
    flavor: 'Pine and shadow. My human used to walk me under these branches.',
  ...
  beach: {
    ...
    transition: 'fade',
    name: '🏖️ Sandy Beach',
    flavor: 'Salt, sun, and a red ball in the sand. Best days end with me running.',
  ...
  mountain: {
    ...
    flavor: 'Thin, sharp wind up here. A human who loved me climbed these switchbacks with me.',
  ...
  garden: {
    ...
    transition: 'fade',
    name: '🌺 Secret Garden',
    flavor: 'Roses and warm earth. This garden was planted by a hand that pet me.',
  ...
  library: {
    ...
    transition: 'wipe',
    name: '📚 Old Library',
    flavor: 'Books that still smell like home — and a voice that read them to me.',
  ...
  market: {
    ...
    transition: 'slide',
    name: '🏪 Town Market',
    flavor: 'A swirl of smells and voices. The cart that always stopped for me is parked here.',
  ...
  cave: {
    ...
    transition: 'zoom',
    name: '🕳️ Crystal Cave',
    flavor: 'Crystals glowing like night-lights in a house I used to sleep in.',
  ...
  waterfall: {
    ...
    flavor: 'The falling water sounds like the house where I was happiest.',
  ...
  park_secret: {
    ...
    transition: 'zoom',
    name: '🌙 Secret Park',
    flavor: 'The park glows under the moon. My human brought me here on quiet nights.',
...
export const ITEMS: Record<string, Item> = {
  ...
  map_fragment: { name: '📋 Map Fragment', desc: 'Part of a map. Shows a street.', category: 'clue', storyNote: 'An edge of the map — one street of the way home, drawn in ink. Follow it and I can go back.' },
  tree_clue: { name: '🌳 Tree Clue', desc: 'A tree you remember. Marked with a scratch.', category: 'clue', storyNote: 'A scratched tree — a mark my human made. The road home passes under it.' },
  friend: { name: '🐕 Friend', desc: 'A new companion!', category: 'comfort' },
  food: { name: '🍎 Food', desc: 'A snack for the road.', category: 'food' },
  collar_piece: { name: '📿 Collar Piece', desc: 'A piece of your collar. You recognize this.', category: 'key', storyNote: 'A piece of my own collar. Whoever dropped this was running too.' },
  leash: { name: '🔗 Leash', desc: 'A red leash. Your human used this.', category: 'key', storyNote: 'A red leash, still smelling like me. My human held the other end.' },
  collar: { name: '🎀 Collar', desc: 'Your collar! You remember wearing this.', category: 'key', storyNote: 'My whole collar. Worn back on, I am almost home.' },
  ...
  photo: { name: '📸 Photo', desc: 'A photo of you and your human. You miss them.', category: 'story', storyNote: 'A photo of me and my human. The way home starts and ends with this face.' },
  blanket: { name: '🧶 Blanket', desc: 'A piece of your favorite blanket. Smells like home.', category: 'comfort', storyNote: 'A corner of my favorite blanket. It smells like the couch — and the couch smells like home.' },
  ...
  lake_stone: { name: '🪨 Lake Stone', desc: 'Smooth stone from the lake shore. Shiny.', category: 'crafting', storyNote: 'A smooth stone from the lake shore — the day my human taught me to fetch.' },
  ...
  compass_fragment: { name: '🧭 Compass Fragment', desc: 'Half a compass. Points toward home.', category: 'crafting', storyNote: 'Half a compass, still pointing the way I came from home. The other half is out there.' },
  ...
  pinecone: { name: '🌲 Pinecone', desc: 'From the forest. Smells like trees.', category: 'collectible', storyNote: 'A pinecone from a forest walk — my human always let me keep one.' },
  ...
  home_photo: { name: '📸 Home Photo', desc: 'A photo of your home. You remember this place.', category: 'story', storyNote: 'A photo of the house. I remember the porch, the steps, the kitchen light.' },
  collar_buckle: { name: '🔗 Collar Buckle', desc: 'Part of your collar. You recognize it.', category: 'key' },
  dog_license: { name: '📋 Dog License', desc: 'Your official dog license. Real proof of home.', category: 'key', storyNote: 'My official license — real proof of who I am and where I belong.' },
  ...
  letter: { name: '✉️ Letter', desc: 'A letter addressed to you. From your human?', category: 'story', storyNote: 'A letter addressed to ME. My human wrote to me — I have to get home to answer.' },
  diary_page: { name: '📄 Diary Page', desc: 'Your human wrote about you here. Sweet.', category: 'story', storyNote: 'A page of my human’s diary: “The day we got him was the best day of my life.”' },
